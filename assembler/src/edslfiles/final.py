...
bg_val_03 = ram.var(0x18, "bg_val_03: dark blue    #000080 (G=0,B=3,R=0)")
bg_val_04 = ram.var(0x1C, "bg_val_04: dark purple  #800080 (G=0,B=3,R=4)")
bg_val_05 = ram.var(0x98, "bg_val_05: dark teal    #008080 (G=2,B=3,R=0)")
bg_val_06 = ram.var(0x46, "bg_val_06: dark orange  #804000 (G=1,B=0,R=6)")
...
bg_val_09 = ram.var(0x82, "bg_val_09: dark olive   #808000 (G=2,B=0,R=2)")
bg_val_10 = ram.var(0x10, "bg_val_10: dark navy    #000060 (G=0,B=2,R=0)")
bg_val_11 = ram.var(0x43, "bg_val_11: dark brown   #804020 (G=1,B=0,R=3)")
bg_val_12 = ram.var(0x14, "bg_val_12: dark indigo  #4B0082 (G=0,B=2,R=4)")
bg_val_13 = ram.var(0x88, "bg_val_13: dark forest  #228B22 (G=2,B=1,R=0)")
bg_val_14 = ram.var(0x52, "bg_val_14: dark slate   #708090 (G=1,B=2,R=2)")
bg_val_15 = ram.var(0x05, "bg_val_15: dark crimson #800020 (G=0,B=0,R=5)")

# Foreground colours (light) — format: GG BBB RRR
# CSS -> R=css_r//32, B=css_b//32, G=css_g//64
fg_base = ram.here()
fg_val_00 = ram.var(0xFF, "fg_val_00: white        #FFFFFF (G=3,B=7,R=7)")
fg_val_01 = ram.var(0x7F, "fg_val_01: yellow       #FFFF00 (G=3,B=0,R=7)")
fg_val_02 = ram.var(0xBF, "fg_val_02: light green  #00FF00 (G=3,B=0,R=0) + R") 
fg_val_03 = ram.var(0xF8, "fg_val_03: light cyan   #00FFFF (G=3,B=7,R=0)")
fg_val_04 = ram.var(0x7E, "fg_val_04: light pink   #FFB6C1 (G=3,B=0,R=6)")
fg_val_05 = ram.var(0xD8, "fg_val_05: light aqua   #7FFFD4 (G=3,B=3,R=0)")
fg_val_06 = ram.var(0x77, "fg_val_06: light peach  #FFDAB9 (G=3,B=0,R=7)")
fg_val_07 = ram.var(0xD6, "fg_val_07: light grey   #C0C0C0 (G=3,B=2,R=6)")
fg_val_08 = ram.var(0x7D, "fg_val_08: light salmon #FA8072 (G=3,B=0,R=5)")
fg_val_09 = ram.var(0x67, "fg_val_09: lime green   #ADFF2F (G=2,B=4,R=7)")
fg_val_10 = ram.var(0xD5, "fg_val_10: sky blue     #87CEEB (G=3,B=2,R=5)")
fg_val_11 = ram.var(0x77, "fg_val_11: light tan    #D2B48C (G=3,B=0,R=7)")
fg_val_12 = ram.var(0xDB, "fg_val_12: lavender     #E6E6FA (G=3,B=3,R=3)")
fg_val_13 = ram.var(0xF8, "fg_val_13: mint         #98FF98 (G=3,B=7,R=0)")
fg_val_14 = ram.var(0xDD, "fg_val_14: light blue   #ADD8E6 (G=3,B=3,R=5)")
fg_val_15 = ram.var(0x7C, "fg_val_15: light rose   #FF007F (G=3,B=0,R=4)")
